...
train_base_folder = r"D:/Kuliah/Project/Python/deteksi_tikus/dateset_tikus"
train_subfolders = ["ada tikus", "tidak ada tikus"]
...
data = pd.read_excel('ekstrasi-data-tikus.xlsx')
