...
file        = 'trainTikus.xlsx'
file_name   = f'D:/Kuliah/Project/Python/deteksi_tikus/dateset_tikus/data_uji/anime.png'
...
plt.subplot(1, 2, 2)
plt.text(0.5, 0.5, f'Predicted Class: {kelas_pred[0]}', ha='center', va='center', fontsize=12)
plt.axis('off')
